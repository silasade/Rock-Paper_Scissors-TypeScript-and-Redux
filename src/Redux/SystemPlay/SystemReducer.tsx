import { ROCK,PAPER,SCISSORS } from "../UserPlay/GameType"
import { SystemActionType } from "./SystemActions"
import { PLAY_RANDOM } from "./SystemType"
type StateType={
    id:number|undefined
    type:string
    image: string
...
export const SystemReducer=(state=initialState,action:SystemActionType)=>{
    switch(action.type){
        case PLAY_RANDOM:
